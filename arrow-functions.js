...
const evaluateScores = (score1, score2, score3) => {
    ...
    if (topScore >= 90) return `Excellent work! Top score: ${topScore}`;
    else if (topScore >= 70) return `Good job! Top score: ${topScore}`;
    else return `Keep practicing! Top score: ${topScore}`;
};
